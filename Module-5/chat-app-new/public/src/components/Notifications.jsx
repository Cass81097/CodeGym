...
export default function Notifications() {
    ...
    return (
        <div className="notifications">
            <div className="notifications-icon" style={{ cursor: "pointer" }} onClick={() => setIsOpen(!isOpen)}>
                <FaEnvelope />
            ...
            {isOpen ? (<div className="notifications-box">
                <div className="notifications-header" >
                    <h3>Notifications</h3>
                    <FaCheckDouble className="mark-as-read" onClick={() => markAllNotificationsAsRead(notifications)}/>
                </div>
